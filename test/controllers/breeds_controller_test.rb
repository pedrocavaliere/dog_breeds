...
class BreedsControllerTest < ActionController::TestCase
  ...
  test "should create breed" do
    assert_difference('Breed.count') do
      post :create, breed: { caracteristicas: @breed.caracteristicas, name: @breed.name, peso: @breed.peso, porte: @breed.porte }
    end
  ...
  test "should update breed" do
    patch :update, id: @breed, breed: { caracteristicas: @breed.caracteristicas, name: @breed.name, peso: @breed.peso, porte: @breed.porte }
    assert_redirected_to breed_path(assigns(:breed))
  end
